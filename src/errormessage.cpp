...
static StringTable stringTableDE{
...
static StringTable stringTableEN{
...
static StringTable stringTableES{
...
static StringTable stringTableFR{
...
static StringTable stringTableJA{
...
static StringTable stringTableKO{
...
static StringTable stringTableRU{
...
static StringTable stringTableZH{
...
void BlueSetErrorMessage(const BlueErrorMessage& message, unsigned int messageId)
{
	auto iter = messageTable.find(de);
	if (iter != messageTable.end())
	{
		iter->second[messageId] = message.de;
	}

	iter = messageTable.find(en);
	if (iter != messageTable.end())
	{
		iter->second[messageId] = message.en;
	}

	iter = messageTable.find(es);
	if (iter != messageTable.end())
	{
		iter->second[messageId] = message.es;
	}

	iter = messageTable.find(fr);
	if (iter != messageTable.end())
	{
		iter->second[messageId] = message.fr;
	}

	iter = messageTable.find(ja);
	if (iter != messageTable.end())
	{
		iter->second[messageId] = message.ja;
	}

	iter = messageTable.find(ko);
	if (iter != messageTable.end())
	{
		iter->second[messageId] = message.ko;
	}

	iter = messageTable.find(ru);
	if (iter != messageTable.end())
	{
		iter->second[messageId] = message.ru;
	}

	iter = messageTable.find(zh);
	if (iter != messageTable.end())
	{
		iter->second[messageId] = message.zh;
	}
	
}

void BlueShowMessageBox(const std::string & title, unsigned int titleId, const std::string & message, unsigned int messageId)
{
	std::string localizedMessage = TranslateErrorMessage(message, messageId);
	std::string localizedTitle = TranslateErrorMessage(title, titleId);
