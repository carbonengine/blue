...
const Be::ClassInfo* AllReferences::ExposeToBlue()
{
	EXPOSURE_BEGIN( AllReferences, "AllReferences maintans reference information (attributes, list indices) between objects." )
		...
		MAP_METHOD_AND_WRAP(
			...
			"The results are returned for data last generated by Update method.\n\n"
			":param obj: child object" )

		MAP_METHOD_AND_WRAP(
			"FindInterface",
			FindInterface,
			"Similar to blue.FindInterface, for the root object. The results are returned for data last generated by Update method.\n\n"
