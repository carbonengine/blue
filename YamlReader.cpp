...
{
	return CCP_MALLOC( "yaml_malloc", size );
}
...
{
	return CCP_REALLOC( "yaml_realloc", ptr, size );
}
...
yaml_char_t* yaml_strdup(const yaml_char_t *str)
{
	if (!str)
		return NULL;

	return (yaml_char_t *)CCP_STRDUP( "yaml_strdup", (char *)str);
}
