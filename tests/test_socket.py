...
class GeneralModuleTests(unittest.TestCase):
    ...
    def test_SocketType_is_socketobject(self):
        self.assertTrue(_socket is _slsocket)
        self.assertTrue(_socket.SocketType is _slsocket.socket)
        self.assertTrue(socket._socket is _slsocket)
        self.assertTrue(socket.SocketType is _slsocket.socket)
        s = socket.socket()
