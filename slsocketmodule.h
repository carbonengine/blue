...
#else /* MS_WINDOWS */
//CCP change, pythonstatic is built with a weird default packing
#ifdef _WIN64
#pragma pack(push, 16)
#else
#pragma pack(push, 8)
...
#ifdef SLSOCKET
 #define PySocket_MODULE_NAME	"_slsocket"
#else
 #define PySocket_MODULE_NAME	"_socket"
#endif
#define PySocket_CAPI_NAME      "CAPI"
#define PySocket_CAPSULE_NAME  ("_socket." PySocket_CAPI_NAME)
...
typedef struct _PySocketSockObject {
    PyObject_HEAD
    SOCKET_T sock_fd;           /* Socket file descriptor */
#ifdef SLSOCKET
    void *sock_xtradata;/* used for slsocket management */
    struct _PySocketSockObject *sock_prev; //for linking up all socket objects
    struct _PySocketSockObject *sock_next;
#endif
